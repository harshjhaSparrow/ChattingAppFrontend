...
var LookingForPartner_gif_1 = __importDefault(
  require("../public/LookingForPartner.gif")
);
var coffeedonutgif_gif_1 = __importDefault(
  require("../public/coffeedonutgif.gif")
);
...
function ChatWindow(_a) {
  ...
  var _d = (0, react_1.useState)(""),
    inputMessage = _d[0],
    setInputMessage = _d[1];
  var _e = (0, react_1.useState)(null),
    partnerId = _e[0],
    setPartnerId = _e[1];
  var _f = (0, react_1.useState)("connecting"),
    status = _f[0],
    setStatus = _f[1];
  ...
  return react_1.default.createElement(
    ...
    {
      className:
        "bg-white flex justify-between flex-col h-full rounded-lg w-full ",
    },
    status === "connecting" &&
      react_1.default.createElement(
        ...
        {
          className:
            "text-center flex justify-center items-center w-full h-full text-gray-500",
        },
        react_1.default.createElement(
          "div",
          null,
          react_1.default.createElement("img", {
            src: coffeedonutgif_gif_1.default,
    ...
    matchedWith &&
      ...
      react_1.default.createElement(
        "div",
        {
          className: "text-lg text-center font-semibold text-primaryTheme mb-4",
        },
        "You\u2019ve matched with:",
        " ",
        react_1.default.createElement(
          ...
          capitalizeFirstLetters(
            matchedWith === null || matchedWith === void 0
              ? void 0
      ...
      ? react_1.default.createElement(
          ...
          react_1.default.createElement(
            "button",
            {
              ...
              className:
                "bg-green-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-green-700 transition-all mt-4",
            },
            "Find New Partner"
          )
        )
          ...
          status === "waiting"
            ? react_1.default.createElement(
                ...
                react_1.default.createElement(
                  ...
                  {
                    className:
                      "messages rounded-full flex justify-center items-center  p-4 mb-4 h-fit overflow-y-hidden",
                  },
                  react_1.default.createElement("img", {
                    src: LookingForPartner_gif_1.default,
            ...
            : react_1.default.createElement(
                ...
                status === "connecting"
                  ...
                  : react_1.default.createElement(
                      ...
                      react_1.default.createElement(
                        "div",
                        { className: "flex flex-col h-60 overflow-y-auto" },
                        react_1.default.createElement(
                          "div",
                          null,
                          messages === null || messages === void 0
                            ...
                            : messages.map(function (msg, index) {
                                return react_1.default.createElement(
                                  ...
                                  {
                                    key: index,
                                    className: "mb-2 flex items-center ".concat(
                                      msg.isOwnMessage
                                        ? "justify-end"
                                        : "justify-start"
                                    ),
                                  ...
                                  react_1.default.createElement(
                                    ...
                                    {
                                      className:
                                        "rounded-md px-2 py-1 text-sm ".concat(
                                          msg.isOwnMessage
    ...
    status === "started" &&
      react_1.default.createElement(
        "div",
        { className: "input-container flex items-center gap-2 mb-4" },
        react_1.default.createElement("input", {
          ...
          className:
            "flex-1 border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-primaryTheme",
        }),
        react_1.default.createElement(
          "button",
          {
            ...
            className:
              "bg-primaryTheme text-white px-4 py-2 rounded-lg font-medium hover:bg-onHoveringPrimaryTheme transition-all ".concat(
        ...
        react_1.default.createElement(
          ...
          react_1.default.createElement(
            "button",
            {
              ...
              className:
                "bg-primaryTheme text-white px-4 py-2 rounded-lg font-medium hover:bg-onHoveringPrimaryTheme transition-all",
            },
    ...
    status === "waiting" &&
      react_1.default.createElement(
        ...
        react_1.default.createElement(
          ...
          {
            className:
              "bg-green-600 text-white w-full text-center px-4 py-2 rounded-lg font-medium hover:bg-green-700 transition-all",
          },
          react_1.default.createElement(
            "span",
            { className: "italic" },
...
function UserRegistration() {
  ...
  return react_1.default.createElement(
    ...
    {
      className:
        "flex flex-col items-center p-4 justify-center bg-white h-full w-full ",
    },
    react_1.default.createElement(
      "div",
      {
        className:
          "text-2xl pl-8 py-4 left font-bold w-full text-center text-primaryTheme",
      },
    ...
    !isRegistered
      ? react_1.default.createElement(
          "div",
          {
            className: "w-full h-full py-6 px-4 flex flex-col justify-between",
          },
          react_1.default.createElement(
            "div",
            {
              className:
                "text-xl font-semibold text-primaryTheme text-center mb-4",
            },
            "Welcome to ChatApp"
          ),
          react_1.default.createElement(
            ...
            {
              className:
                "bg-gray-50 p-6 rounded-2xl shadow-md max-w-lg mx-auto",
            },
            react_1.default.createElement(
              "h2",
              {
            ...
            react_1.default.createElement(
              ...
              react_1.default.createElement(
                ...
                react_1.default.createElement(
                  "span",
                  { className: "mr-2 text-blue-500 font-semibold" },
                  "\u2022"
                ),
          ...
          react_1.default.createElement(
            ...
            react_1.default.createElement("input", {
              ...
              className:
                "w-full border border-gray-300 rounded-lg p-2 mb-2 focus:outline-none focus:ring-2 focus:ring-primaryTheme",
            }),
            error &&
              react_1.default.createElement(
                "p",
            ...
            react_1.default.createElement(
              "button",
              {
                ...
                className:
                  "w-full bg-primaryTheme text-white font-medium py-2 rounded-lg hover:bg-onHoveringPrimaryTheme transition-all",
              },
              "Register"
            )
          )
        )
      : react_1.default.createElement(ChatWindow, { username: username })
  );
}
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        react_1.default.createElement(
          ...
          react_1.default.createElement(
            "div",
            { className: "bg-white shadow-lg rounded-lg w-full h-screen " },
